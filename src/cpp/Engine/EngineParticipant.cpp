        ...
        std::string listening_address)
{
    ...
    //CREATE THE DL TOPIC
    dl_topic_ = participant_->create_topic(DL_TOPIC, DL_TOPIC_TYPE, TOPIC_QOS_DEFAULT);
    ...
    atomization_topic_ = participant_->create_topic(ENGINE_TOPIC, ENGINE_TOPIC_TYPE, TOPIC_QOS_DEFAULT);
